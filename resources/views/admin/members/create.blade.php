...
@section('content')
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 max-w-3xl">
        <div class="p-6 border-b border-gray-100">
            <h2 class="text-lg font-semibold text-gray-800">Tambah Member Baru</h2>
        </div>

        <form action="{{ route('admin.members.store') }}" method="POST" class="p-6 space-y-6">
            @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <select name="membership_type"
                        ...
                        <option value="platinum" {{ old('membership_type') == 'platinum' ? 'selected' : '' }}>Platinum</option>
                    </select>
                ...
                <div>
                    ...
                    <input type="number" name="quota" value="{{ old('quota', 30) }}" min="0" max="999"
                    ...
                    <p class="text-xs text-gray-400 mt-1">Default: 30 kali masuk</p>
            ...
            <div>
                ...
                <textarea name="address" rows="2"
                          class="w-full rounded-lg border-gray-300 px-4 py-2.5 text-sm focus:ring-red-500 focus:border-red-500 @error('address') border-red-500 @enderror">{{ old('address') }}</textarea>
            ...
            <div>
                ...
                <textarea name="notes" rows="3"
                          class="w-full rounded-lg border-gray-300 px-4 py-2.5 text-sm focus:ring-red-500 focus:border-red-500 @error('notes') border-red-500 @enderror">{{ old('notes') }}</textarea>
            ...
            <div class="flex items-center justify-end space-x-3 pt-4 border-t border-gray-100">
                ...
                <button type="submit" class="bg-red-600 hover:bg-red-700 text-white px-6 py-2.5 rounded-lg text-sm font-semibold transition">Simpan Member</button>
            </div>
        </form>
    </div>
@endsection
